...
//высота и ширина окна браузера доступная для работы
let mainElement = document.documentElement; //обращаемся к тегу HTML 
let elementHeigth = mainElement.clientHeight;
let elementWidth = mainElement.clientWidth;
console.log(elementHeigth);
console.log(elementWidth);
//ширина и высота окна вместе с полоской прокрутки
let windowHeight = window.innerHeigth;
let windowWidth = window.innerWidth;
console.log(windowWidth);
console.log(windowHeight);
//ширина и высота включая прокрутку
...
//количество прокрученных пикселей на данный момент
*/
//========================================================================================================================================================
//========================================================================================================================================================
//========================================================================================================================================================
